...
//WebUI.click(findTestObject('Transfer/Beranda/Page_iBBIZ BRI/i_Tidak_fa fa-arrow-down my-float-down'))
//
//WebUI.click(findTestObject('Transfer/Beranda/Page_iBBIZ BRI/button_TOLAK'))
